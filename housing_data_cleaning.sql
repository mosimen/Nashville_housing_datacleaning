...
--Add a new column with the right data type to the housing table, then set it to the SaleDate data
...
order by ParcelID
----But we notice that ParcelID that is that same has same PropertyAddress 

--We will join the dataset with itself
...
--Extracting Address, City and State but we will not use substring this time. Let us try the PARSENAME method
select *
from NashvilleHousing
